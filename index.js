...
var requiredData_1 = require("./requiredData");
console.log(requiredData_1.default);
...
requiredData_1.default.forEach(function (el) {
...
function searchText(inputData) {
    ...
    var found = inputString.match(inputData.regexRule);
