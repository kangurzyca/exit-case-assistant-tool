...
export const requiredData: IFetchedData[]= [
...

    {
        ...
        regexRule: new RegExp(
            "address line 1\\s*([\\w\\s]+)\\s*address line 2",
            "i"
        ),
    },
    {
        ...
        type: "addressLineTwo",
        regexRule: new RegExp(
            "\\baddress line 2\\b\\s*([\\w\\d\\s]+)\\s*\\bcity\\/town\\b",
            "i"
        ),
    },
    {
        ...
        type: "addressTown",
        regexRule: new RegExp(
            "\\bcity\\/town\\b\\s*([\\w\\d\\s]+)\\s*\\bpostcode\\b",
            "i"
        ),
    },
    {
        ...
        regexRule: new RegExp(
            "\\bpostcode\\b\\s*(\\b[a-zA-Z0-9]{2,4}\\s[a-zA-Z0-9]{3}\\b)",
            "i"
        ),
    },
    {
    ...
    },
    {
        ...
        type: "phoneNumber",
        regexRule: new RegExp(
            "\\bnumbers*\\(optional\\)\\s*((?:\\d{11}|\\+44\\s?\\d{12})(?:\\s+(?:\\d{11}|\\+44\\s?\\d{12}))*)",
            "g"
        ),
    },
    {
